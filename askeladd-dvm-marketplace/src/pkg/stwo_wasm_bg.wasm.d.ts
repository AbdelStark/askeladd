...
export function stark_proof_multi_fibo(a: number, b: number, c: number, d: number): number;
...
export function prove_and_verify(a: number): number;
export function verify_stark_proof(a: number, b: number, c: number): number;
export function prove_and_verify_fib(a: number, b: number): number;
export function verify_stark_proof_fib(a: number, b: number, c: number, d: number): number;
