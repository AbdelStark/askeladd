        ...
        {internalProgram?.map((p, i) => {
          ...
          return (
            <div className="mx-auto max-w-lg p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              {/* <p>{p.request}</p> */}
              <p>{p.program_params?.event_id}</p>
              <p>{p.program_params?.contract_name?.toString()}</p>
              {/* <p>{p.program_params?.internal_contract_name}</p> */}
              <p>Deployed: {p.program_params?.contract_reached == ContractUploadType.InternalAskeladd && "Internal Program"}</p>
